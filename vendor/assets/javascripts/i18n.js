(function(){
  ...
  // shortcuts
  var previousT = root.t;
  I18n.t = root.t = function(){ return I18n.translate.apply(I18n,arguments); };

  var previousL = root.l;
  I18n.l = root.l = function(){ return I18n.localize.apply(I18n,arguments); };
  
  var previousP = root.p;
  I18n.p = root.p = function(){ return I18n.pluralize.apply(I18n,arguments); };

  I18n.noConflict = function( deep ) {
    root.t = previousT; root.l = previousL; root.p = previousP;
